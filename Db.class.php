...
// or define DB_HOST, DB_NAME, DB_USERNAME, and DB_PASSWORD here
...
class Db {
	...
	static function connect() {
		if (!self::connected()) {
			try {
				self::$db_connection = new PDO('mysql:host=' . DB_HOST . ';dbname=' . DB_NAME . ';charset=UTF-8', DB_USERNAME, DB_PASSWORD);
